...
function populatePortfolio(data){
	...
	var table = $("#items");
	    $.each(data, function(idx, elem){
	        table.append("<tr><td>"+elem.company+"</td><td>"+elem.quantity+"</td><td>"+elem.buyPrice+"</td></tr><td>"+elem.totalPurchasePrice+"</td><td>"+elem.currentmarketvalue+"</td><td>"+elem.realizedPLAmt+"</td><td>"+elem.realizedPLAmtPer+"</td><td>"+elem.restUrl+"</td>");
	    });
